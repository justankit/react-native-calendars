...
class CalendarHeader extends Component {
  ...
  render() {
    ...
    const {testID, month, minDate, maxDate} = this.props;
    let disableArrowLeft = this.props.disableArrowLeft || month.getTime() <= minDate.getTime();
    let disableArrowRight = this.props.disableArrowRight || month.getTime() >= maxDate.getTime();
        ...
        >
          {this.props.renderArrow
            ...
            : <Image
              ...
              style={disableArrowLeft ? this.style.disabledArrowImage : this.style.arrowImage}
            />}
        </TouchableOpacity>
      );
      rightArrow = (
        ...
        >
          {this.props.renderArrow
            ...
            : <Image
              ...
              style={disableArrowRight ? this.style.disabledArrowImage : this.style.arrowImage}
            />}
        </TouchableOpacity>
      );
    }
